...
// ADD DOCS
export class ChannelCodecQualityUpdatedEvent extends Event {
    override async handle(data: any) {
        ...
        const newCodecQuality = data.channelCodecQuality;

        queryClient.emit(QueryClientEvents.ChannelCodecQualityUpdated, invokingClient, channel, newCodecQuality);
    }
}
