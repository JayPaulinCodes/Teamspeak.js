...
// ADD DOCS
export class ChannelMaxClientsUpdatedEvent extends Event {
    override async handle(data: any) {
        ...
        const newMaxClients = data.channelMaxclients;

        queryClient.emit(QueryClientEvents.ChannelMaxClientsUpdated, invokingClient, channel, newMaxClients);
    }
}
